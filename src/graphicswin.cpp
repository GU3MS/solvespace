...
{ 1, NULL,    Command::GROUP_WRKPL,      S|'W',   TN, mGrp  },
{ 1, NULL,                              Command::NONE,             0,       TN, NULL  },
{ 1, NULL,           Command::GROUP_TRANS,      S|'T',   TN, mGrp  },
{ 1, NULL,              Command::GROUP_ROT,        S|'R',   TN, mGrp  },
{ 1, NULL,                              Command::NONE,             0,       TN, NULL  },
{ 1, NULL,                    Command::GROUP_EXTRUDE,    S|'X',   TN, mGrp  },
{ 1, NULL,                      Command::GROUP_LATHE,      S|'L',   TN, mGrp  },
{ 1, NULL,                              Command::NONE,             0,       TN, NULL  },
{ 1, NULL,          Command::GROUP_LINK,       S|'I',   TN, mGrp  },
{ 1, NULL,                 Command::GROUP_RECENT,     0,       TN, mGrp  },

{ 0, NULL,                     Command::NONE,             0,       TN, NULL  },
{ 1, NULL,               Command::SEL_WORKPLANE,    '2',     TR, mReq  },
{ 1, NULL,             Command::FREE_IN_3D,       '3',     TR, mReq  },
{ 1, NULL,                              Command::NONE,             0,       TN, NULL  },
{ 1, NULL,                Command::DATUM_POINT,      'P',     TN, mReq  },
{ 1, NULL,                  Command::WORKPLANE,        0,       TN, mReq  },
{ 1, NULL,                              Command::NONE,             0,       TN, NULL  },
{ 1, NULL,               Command::LINE_SEGMENT,     'S',     TN, mReq  },
{ 1, NULL,  Command::CONSTR_SEGMENT,   S|'S',   TN, mReq  },
{ 1, NULL,                  Command::RECTANGLE,        'R',     TN, mReq  },
{ 1, NULL,                     Command::CIRCLE,           'C',     TN, mReq  },
{ 1, NULL,            Command::ARC,              'A',     TN, mReq  },
{ 1, NULL,        Command::CUBIC,            'B',     TN, mReq  },
{ 1, NULL,                              Command::NONE,             0,       TN, NULL  },
{ 1, NULL,      Command::TTF_TEXT,         'T',     TN, mReq  },
{ 1, NULL,                      Command::IMAGE,            0,       TN, mReq  },
{ 1, NULL,                              Command::NONE,             0,       TN, NULL  },
{ 1, NULL,        Command::CONSTRUCTION,     'G',     TN, mReq  },
{ 1, NULL,       Command::TANGENT_ARC,      S|'A',   TN, mReq  },
...
{ 1, NULL,  Command::OTHER_ANGLE,      'U',     TN, mCon  },
{ 1, NULL,       Command::REFERENCE,        'E',     TN, mCon  },
{ 1, NULL,                              Command::NONE,             0,       TN, NULL  },
{ 1, NULL,                 Command::HORIZONTAL,       'H',     TN, mCon  },
{ 1, NULL,                   Command::VERTICAL,         'V',     TN, mCon  },
{ 1, NULL,                              Command::NONE,             0,       TN, NULL  },
{ 1, NULL,   Command::ON_ENTITY,        'O',     TN, mCon  },
{ 1, NULL, Command::EQUAL,         'Q',     TN, mCon  },
{ 1, NULL,               Command::RATIO,            'Z',     TN, mCon  },
{ 1, NULL,          Command::DIFFERENCE,       'J',     TN, mCon  },
{ 1, NULL,                Command::AT_MIDPOINT,      'M',     TN, mCon  },
{ 1, NULL,                 				Command::SYMMETRIC,        'Y',     TN, mCon  },
{ 1, NULL,         						Command::PARALLEL,         'L',     TN, mCon  },
{ 1, NULL,              				Command::PERPENDICULAR,    '[',     TN, mCon  },
{ 1, NULL,           					Command::ORIENTED_SAME,    'X',     TN, mCon  },
{ 1, NULL,   							Command::WHERE_DRAGGED,    ']',     TN, mCon  },
{ 1, NULL,                              Command::NONE,             0,       TN, NULL  },
{ 1, NULL,                     			Command::COMMENT,          ';',     TN, mCon  },

{ 0, NULL,                    			Command::NONE,             0,       TN, NULL  },
{ 1, NULL,             					Command::VOLUME,           C|S|'V', TN, mAna  },
{ 1, NULL,               				Command::AREA,             C|S|'A', TN, mAna  },
{ 1, NULL,          					Command::PERIMETER,        C|S|'P', TN, mAna  },
{ 1, NULL,     							Command::INTERFERENCE,     C|S|'I', TN, mAna  },
{ 1, NULL,           					Command::NAKED_EDGES,      C|S|'N', TN, mAna  },
{ 1, NULL,        						Command::CENTER_OF_MASS,      C|S|'C', TN, mAna  },
{ 1, NULL,                              Command::NONE,             0,       TN, NULL  },
{ 1, NULL,    							Command::SHOW_DOF,         C|S|'F', TN, mAna  },
{ 1, NULL,                              Command::NONE,             0,       TN, NULL  },
{ 1, NULL,               				Command::TRACE_PT,         C|S|'T', TN, mAna  },
...
void GraphicsWindow::MenuView(Command id) {
    switch(id) {
        ...
        case Command::ONTO_WORKPLANE: {
	        ...
	        ifstream infile;
	        infile.open ("dpi.txt");
	        getline(infile, DPI); // Saves the line in DPI.
	        infile.close();
